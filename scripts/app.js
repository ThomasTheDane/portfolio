$( document ).ready(function() {
	...
	$('.proficiencyPiece#javascript').on('mouseover', function(){
		$('#proficiencyFloater').html('<h4>One of my favorite languages. Full understanding of a multitude of features, including object structures and its interesting treatment of functions.</h4>');
	});
	$('.proficiencyPiece#htmlcss').on('mouseover', function(){
		$('#proficiencyFloater').html('<h4>Basic building blocks for other frameworks. Very familiar with its simple structure and available markup properties. Used to write the site you see here.</h4>');
	});
